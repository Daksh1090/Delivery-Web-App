...
function RestruantEditrFood() {
  ...
  useEffect(() => {
    const fetchFood = async () => {
      try {
        const res = await api.get(`/api/get_foodDetail/${foodId}`);
        const food = res.data;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.patch(`/api/edit-food/${foodId}`, formData, {
...
export default RestruantEditrFood;
